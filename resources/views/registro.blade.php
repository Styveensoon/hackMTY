...
<link href="/HackMTY/resources/css/bootstrap.min.css" rel="stylesheet">
    ...
    <style>
    body {
      background: linear-gradient(to right, #000000, #87CEEB); 
      margin: 0;
      padding: 0;
          ...
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <div class="invalid-feedback">
                Es requirido colocar tu ID de tu empresa
              </div>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <div class="invalid-feedback">
                Es requirido colocar tus datos completos 
              </div>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" id="firstName2" placeholder="" value="" required>
              <div class="invalid-feedback">
                Es requirido colocar tus datos completos 
              </div>
            </div>
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" for="same-address">Acepto los terminos de privacidad presentados</label>
            </div>
            <hr class="my-4">
         <br>
         <button class="w-100 btn btn-custom-green btn-lg" type="submit">Ingresar</button>
        </form>
      </div>
    </div>
  </main>
