...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    ...
    .navbar-brand img {
    margin-right: 8px; /* Ajusta el espaciado entre la imagen y el texto */
...
.carousel-inner {
  position: relative;
  height: 100vh; /* O una altura fija si prefieres */
}
...
.carousel-caption {
  ...
  text-align: left; /* Centra el texto a la izquierda */
  color: #fff; /* Color del texto, ajusta según el fondo */
}
.carousel-item {
  position: relative;
  overflow: hidden;
...
.custom-margin-top {
  margin-top: 4rem; /* Ajusta este valor según sea necesario */
}
...
<main> 
  <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
      ...
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption text-start">
            <h1>Gestiona tu comunicación y tu equipo con control total</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container marketing mt-5 custom-margin-top">
